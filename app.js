    ...
    <div class="item">
      <div class="active-card-body">
        ...
        <div class="active-card-links">
          ${item.ebay_link ? `<a class="market-link market-link-ebay" href="${safe(item.ebay_link)}" target="_blank" rel="noreferrer" style="padding:8px 12px;border-radius:12px;background:rgba(138,180,255,0.15);color:#8ab4ff;font-size:14px;text-decoration:none;display:inline-block;">🔗 eBay</a>` : ''}
          ${item.olx_link ? `<a class="market-link market-link-olx" href="${safe(item.olx_link)}" target="_blank" rel="noreferrer" style="padding:8px 12px;border-radius:12px;background:rgba(34,197,94,0.15);color:#7df0a3;font-size:14px;display:inline-block;text-decoration:none;">✅ OLX</a>` : ''}
          ${item.telegram_link ? `<a class="market-link market-link-telegram" href="${safe(item.telegram_link)}" target="_blank" rel="noreferrer" style="padding:8px 12px;border-radius:12px;background:rgba(139,92,246,0.15);color:#d8b4fe;font-size:14px;display:inline-block;text-decoration:none;">✈️ Telegram</a>` : ''}
        </div>
      </div>
    </div>
  `;
