    ...
    extra.innerHTML = `
      <div class="form-grid" style="margin-top:12px">
        ...
        <div class="span-3 additional-costs-toggle-row">
          <button id="additionalCostsToggle" class="ghost additional-costs-toggle" type="button" aria-expanded="false">Додаткові витрати</button>
        </div>
